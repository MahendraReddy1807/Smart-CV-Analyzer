  ...
  const req = http.request(options, (res) => {
    ...
    res.on('end', () => {
      try {
        ...
        console.log('\n✅ Resume Analysis Results (Data Scientist):');
        ...
        console.log('- Skills:', analysis.sections?.skills?.slice(0, 10).join(', ') + (analysis.sections?.skills?.length > 10 ? '...' : ''));
...
console.log('Testing resume upload with Data Scientist resume...\n');
testUpload();