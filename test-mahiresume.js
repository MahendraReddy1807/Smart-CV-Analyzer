/**
 * Test the specific Mahiresume.pdf file that was failing
 */
...
async function testMahiresume() {
    console.log('🔧 Testing Mahiresume.pdf specifically...\n');
    
    const testFile = 'Mahiresume.pdf';
...
// Run the test
testMahiresume().catch(console.error);